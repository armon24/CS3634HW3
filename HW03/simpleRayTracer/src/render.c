...
void renderKernel(const int NI,
  ...
  //J should be height and is the  number of rows  in the pixel image
  //I should be the width and is the is the number of columns  in the pixel image

  //MPI_Init(&argc, &argv); this is already in main.
  ...
  for(int J = 0; J < NJ; ++J){
	...
	c.blue  += sc*newc.blue;
      ...
      /*Q6: This is where the img array is generated.  Use this as a guide
       *    when sending pixels to rank 0
       *
       */
